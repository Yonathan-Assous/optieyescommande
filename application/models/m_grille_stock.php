    ...
    public function getGrilleStock($data){
        ...
        if($data['id_generation_verre'] == 21) {
            ...
            if(isset($data['miroir']) && $data['miroir'] != "undefined" && $data['miroir'] != 0) {
				...
				if($data['id_generation_verre'] == '12')
				{
					$libelle_verre = "AND libelle_verre like '%".$data['traitement']."%' AND libelle_verre not like '%Bleu nuit%' AND libelle_verre like '%".$data['teinte']."%'";
				}
				else
				{
