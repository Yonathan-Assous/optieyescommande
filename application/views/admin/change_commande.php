...
?>
    ...
    <script>
        // JavaScript Document
        let type_commande_verre = 1;
        let commande = <?php echo $commande->id_commande; ?>;
  ...
  */
   ...
   */
            ...
            $('#type_de_verreD').on('change', function() {
                ...
                var type_de_verreD = $(this).find('option:selected').attr('rel');
...
// console.log(($('#type_de_verreD').find('option:selected').attr('rel')).indexOf("]") >= 0)
// console.log(($(this).find('option:selected').attr('rel')).indexOf("]") >= 0)
                if (type_de_verreD && type_de_verreD.indexOf("]") >= 0)
                {
                    ...
                    else
                    {
                        ...
                        for (let i = 0; i < diametre_type_de_verreD.length-1; i++) {
	...
	if (String(axeG).indexOf(".00") >= 0)
	{
		axeG = String(axeG).replace('.00', '');
            ...
            $('#type_de_verreG').on('change', function() {
                ...
                var generation = $('#generation').val();
                var lensFocalGroup = $('#lensFocalGroup').val();
                var type_de_verreG = $(this).find('option:selected').attr('rel');
                var sphereD = $('#sphereD').val();
                var cylindreD = $('#cylindreD').val();
                var axeD = $('#axeD').val();
                var additionD = $('#additionD').val();
                ...
                if (type_de_verreG && type_de_verreG.indexOf("]") >= 0)
                {
		...
		*/
		...
		if (String(axeG).indexOf(".00") >= 0)
		{
			axeG = String(axeG).replace('.00', '');
                    ...
                    let tab_verres_stock = {};
                    let tab_verres = {};
                    let is_teledetourage = <?php echo !$commande->code_oma ? 'false' : 'true' ?>;
                    if(cylindreD != '-' && droite)
                    {
                        ...
                        //alert("indiceId:"+indiceId+" ,lensFocalGroup:"+lensFocalGroup+" ,generation:"+generation+" ,sphereD:"+sphereD+" ,sphereG:"+sphereG+" ,cylindreD:"+cylindreD+" ,cylindreG:"+cylindreG+" ,axeD:"+axeD+" ,axeG:"+axeG+" ,additionD:"+additionD+" ,additionG:"+additionG+" ,stockD:"+stockD+" ,stockG:"+stockG+" ,progressionD:"+progressionD+" ,progressionG:"+progressionG);
                        if(!is_teledetourage || is_teledetourage == 'false' && (indiceId == "1.5" || indiceId == "1.6" || indiceId == "1.59" || indiceId == "1.67") && (lensFocalGroup == "1" || ((lensFocalGroup == "3" && ((progressionD == 'Short' || progressionD == 'Tous')) && (generation == "Progressif de stock")))) && (stockD == 'StockD' || stockD == 'ToutD'))
                        {
                            $.ajax({
                                type: "POST",
                                    ...
                                    if((value.name.indexOf("Panier A ") >= 0))
                                    {
                                        if(((parseFloat(cylindreD)+parseFloat(sphereD)) >= -2 && (parseFloat(cylindreD)+parseFloat(sphereD)) <= 2 && indiceId == "1.5") || ((parseFloat(cylindreD)+parseFloat(sphereD)) >= -4 && (parseFloat(cylindreD)+parseFloat(sphereD)) <= 4 && indiceId == "1.59") || ((parseFloat(cylindreD)+parseFloat(sphereD)) >= -4 && (parseFloat(cylindreD)+parseFloat(sphereD)) <= 4 && indiceId == "1.6") || ((parseFloat(cylindreD)+parseFloat(sphereD)) >= -8 && (parseFloat(cylindreD)+parseFloat(sphereD)) <= 8 && indiceId == "1.67") || (indiceId == "1.74") )
                                        {
                                            ...
                                            if(generation == "Progressif de stock") {
                                                tab_verres_stock[value.sorting]['name'] = value.name;
                                                tab_verres_stock[value.sorting]['code'] = ']'+ value.id_verre;
                                            }
                                            else {
                        ...
                        if(lensFocalGroup != "" && lensFocalGroup !="-")
                        {
                            ...
                            $.ajax({
                                ...
                                data: {"teledetourage" : is_teledetourage, "indiceId" : indiceId, "lensFocalGroup" : lensFocalGroup, "generation" : generation,"sphereD" : sphereD,"cylindreD" : cylindreD,"axeD" : axeD,"additionD" : additionD,"stockD" : stockD,"panierA" : panierA},
                                dataType: "json",
                                async: false,
                                success: function (data) {
                                    console.log("Droit3:");
                    ...
                    if(cylindreG != '-' && gauche)
                    {
                        ...
                        //alert("indiceId:"+indiceId+" ,lensFocalGroup:"+lensFocalGroup+" ,generation:"+generation+" ,sphereD:"+sphereD+" ,sphereG:"+sphereG+" ,cylindreD:"+cylindreD+" ,cylindreG:"+cylindreG+" ,axeD:"+axeD+" ,axeG:"+axeG+" ,additionD:"+additionD+" ,additionG:"+additionG+" ,stockD:"+stockD+" ,stockG:"+stockG+" ,progressionD:"+progressionD+" ,progressionG:"+progressionG);
                        if(!is_teledetourage || is_teledetourage == 'false' && (indiceId == "1.5" || indiceId == "1.6" || indiceId == "1.59" || indiceId == "1.67") && (lensFocalGroup == "1" || lensFocalGroup == "6" || ((lensFocalGroup == "3" && ((progressionG == 'Short' || progressionG == 'Tous')) && generation == "Progressif de stock"))) && (stockG == 'StockD' || stockG == 'ToutD'))
						{
								...
								success: function (data) {
                                    $.each(data, function(key, value){
                                        ...
                                        else
                                        {
                                            ...
                                            tab_verres_stockG[value.sorting]['id'] = value.id_verre;
                                            if(generation == "Progressif de stock") {
                                                tab_verres_stockG[value.sorting]['name'] = value.name;
                                                tab_verres_stockG[value.sorting]['code'] = ']'+ value.id_verre;
                                            }
                                            else {
                                                tab_verres_stockG[value.sorting]['name'] = value.name + ' - Stock';
                                                tab_verres_stockG[value.sorting]['code'] = ']'+ value.id_verre +'*'+value.diametre;
                        ...
                        if(lensFocalGroup != "" && lensFocalGroup !="-") {
                            $.ajax({
                                ...
                                url: "/admin/getTypeDeVerre",
                                data: {
                                    "teledetourage" : is_teledetourage,
                                    "indiceId": indiceId,
                                    "lensFocalGroup": lensFocalGroup,
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $( "#to_etape2" ).click(function() {
                        ...
                        let typeD;
                        let typeG;
                        var type_de_verreD = $('#type_de_verreD').find('option:selected').attr('rel');
                        var type_de_verreG = $('#type_de_verreG').find('option:selected').attr('rel');
                        let selectedTextD = $("#type_de_verreD option:selected").html();
                        let selectedTextG = $("#type_de_verreG option:selected").html();

                        if (type_de_verreD.indexOf("]") >= 0) {
                            typeD = 'stock';
                        }
                        else {
                            if (selectedTextD.indexOf("déporté") >= 0) {
                                typeD = 'deporte';
                            }
                            else {
                                typeD = 'fab';
                        ...
                        if (type_de_verreG.indexOf("]") >= 0) {
                            ...
                            if (selectedTextG.indexOf("déporté") >= 0) {
                                typeG = 'deporte';
                            }
                            else {
                                typeG = 'fab';
                        ...
                        if(g == 0)
                        {
                            $.ajax({
                                type: "POST",
                                url: "/admin/updateCommande/<?php echo $commande->id_commande ?>",
                                data : '<?php echo 'information_commande='.$information_commande.'&'; ?>' + '<?php echo 'user_id='.$commande->id_users.'&'; ?>' + '&type=' + typeD + '&' +formData,
                                dataType:"html",
                                beforeSend:function(){
                                ...
                                success: function(data){
                                    if(data=="error"){
                                        ...
                                        if (typeD == 'fab') {
                                            window.location.replace("/admin/valid_commande");
                                        }
                                        else {
                                            window.location.replace("/admin/valid_commande_stock");
                                        }
                                    }
                                },
                                error : function(){
