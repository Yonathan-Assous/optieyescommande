                ...
                <td>
                    ...
                    if($recap_commande !== false) {
                        ...
                        if($correction_droit!=''){
                            ...
                            echo '<h4 style="text-align: left">Verre oeil droit : '.$recap_commande[0]->trad_fr.$recap_commande[0]->libelle_verre.'</h4>';
                        ...
                        if($correction_gauche!=""){
                            ...
                            echo '<h4 style="text-align: left">Verre oeil gauche : '.$recap_commande[0]->trad_fr.$recap_commande[0]->libelle_verre.'</h4>';
                ...
                <td>
                    ...
                    if($ancienne_commande !== false) {
                        ...
                        if ($correction_droit != '') {
                            ...
                            echo '<h4 style="text-align: left">Verre oeil droit : ' .$ancienne_commande[0]->trad_fr. $ancienne_commande[0]->libelle_verre . '</h4>';
                            echo $correction_droit;
                        ...
                        if ($correction_gauche != "") {
                            ...
                            echo '<h4 style="text-align: left">Verre oeil gauche : '.$ancienne_commande[0]->trad_fr . $ancienne_commande[0]->libelle_verre . '</h4>';
                            echo $correction_gauche;
