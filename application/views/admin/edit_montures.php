...
?>
    ...
    <div class="content-page montures-add">
    <!-- Start content -->
    <div class="content">
        <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form method="post">
                            ...
                            <button type="submit" class="btn btn-danger pull-right">Supprimer cette monture</button>
                        </form>
                        ...
                        <form method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="name">Nom des montures</label>
                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $montures_data[0]->name ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if('' !== $montures_data[0]->image) {
                                    echo '<img src="'.site_url('uploads/'.$montures_data[0]->image).'" class="montures_image" />';
                                } ?>
                            ...
                            <div class="form-group">
                                <label for="packaging">montures par boite</label>
                                <input type="text" class="form-control" id="packaging" name="packaging" value="<?php echo $montures_data[0]->packaging ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="price" name="price" value="<?php echo $montures->price ?>" />
                            </div>

                            <div class="form-group">
                                <label for="generation_id">Type de montures</label>
                                <select name="generation_id" class="form-control">
                                    <?php
                                        foreach($montures_generations as $gen) {
                                            echo '<option value="'.$gen->id.'" '.($montures_data[0]->generation_id == $gen->id ? 'selected' : '').'>'.$gen->name.'</option>';
                                        }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="brand_id" class="form-control">
                                    <?php
                                    foreach($montures_brands as $brand) {
                                        echo '<option value="'.$brand->id.'" '.($montures_data[0]->brand_id == $brand->id ? 'selected' : '').'>'.$brand->name.'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="checkbox" value="1" name="progressive" id="progressive" <?php echo $montures_data[0]->progressive == 1 ? 'checked' : '' ?> /> <label class="control-label" for="progressive"> Progressives</label>
                            </div>

                            <div class="form-group">
                                <input type="checkbox" value="1" name="toric" id="toric" <?php echo $montures_data[0]->toric == 1 ? 'checked' : '' ?> /> <label class="control-label" for="toric"> Toriques</label>
                            </div>


                            <?php
                                $build = json_decode($montures_data[0]->data, true);
                            ?>
                            ...
                            <button type="submit" class="btn btn-warning">Modifier ces montures</button>
