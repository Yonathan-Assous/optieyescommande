        ...
        $('.step').on('click', '.nav-pills a', function() {
            ...
            if(step.next('.step').attr('id') == 'brand') {
                ...
                var data = {
                    ...
                    'progressive' : parseInt($('#progressive').data('value')),
                    'toric' : parseInt($('#toric').data('value'))
                };

                $.ajax({
                    type: "POST",
                    url: "/admin/get_lens_brands",
                    data: data
                }).done(function (data) {
