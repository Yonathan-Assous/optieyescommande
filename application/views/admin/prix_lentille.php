    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ajax: { url: "/admin/prix_lentille_ajax/<?php echo $id_generation; ?>", dataSrc: 'aaData' },
                deferRender: true,
                ordering: false,
                language: {
            ...
            $(".content").on("change", "#grille_tarifaire", function(){
                table.ajax.url('/admin/prix_lentille_ajax/<?php echo $id_generation; ?>/'+$(this).val()).load();
            });
            ...
            $(".content").on("keyup","input[name^=prix_]", function(){
                if($.isNumeric($(this).val())){
                    ...
                    var value = $.trim($(this).val()), id_lentille = $(this).attr("id").split("_")[1], id_grille_tarifaire = $(this).attr("id").split("_")[2];
                    ...
                    Timer = setTimeout( function( ) {
                        $.ajax({
                            type: "POST",
                            url: "/admin/updatePrixLentille",
                            data : "id_lentille="+id_lentille+"&id_grille_tarifaire="+id_grille_tarifaire+"&prix_lentille="+value,
