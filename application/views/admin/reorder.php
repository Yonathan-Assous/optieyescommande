	...
	<div class="content">
		<div class="container">
            <div class="row">
                <div class="col-sm-12 m-b-10">
                    <h4 class="page-title">Repasser la commande CR<?php echo $recap_commande->id_commande.'-'.$id_users; ?></h4>
                </div>
            </div>
        ...
        <tbody>';
                            ...
                            if($correction_droit!=''){
								...
								if($recap_commande['libelle_verre'] == "")
								{
									$recap_commande['libelle_verre'] = $recap_commande['trad_fr'];
								}
                    ...
                    <p>'.$recap_commande['commentaire'].'</p>
						...
						//echo "COmmentaires actifs: ".$commentaire_actif->active;
						//var_dump($commentaire_actif);
						
						if($commentaire_actif->active == 1)
							if(isset($user_info->show_commentaire) && $user_info->show_commentaire == 1) {
							?>
						<div class="form-group commentaire clearfix" style="display: block">
                        ...
                        <div class="text-center">
                            <a href="/admin" class="btn btn-default btn-lg waves-effect waves-light">Annuler</a>
                    ...
                    success: function(data){
                        ...
                        if(data.status == 'ok') {
                            ...
                            swal({
                                ...
                                window.location.href = '/admin/ancienne_commande';
                            });
