    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <h4 class="page-title m-b-10 pull-left">Commandes de lentilles</h4>
                    <div class="pull-right" style="padding-bottom: 6px">
                        <a class="btn btn-danger pull-left m-r-10" id="envoi_commande_journaliere" rel="3"><i class="zmdi zmdi-shopping-cart m-r-5"></i> Liste pour commander</a>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card-box buttons-box clearfix">
                        ...
                        <a class="btn btn-danger pull-left m-r-10" id="generer_bl" rel="2"><i class="zmdi zmdi-shopping-cart m-r-5"></i> Générer BL</a>
                        <a class="btn btn-warning pull-left" id="expedier_lentilles"><i class="zmdi zmdi-truck m-r-5"></i> Expedier commandes checkées (<b></b>)</a>
                    </div>
                </div>
                    ...
                    <div class="card-box">
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "/admin/lens_check_count",
                                    success: function(data){
                                        $('#expedier_lentilles').find('b').text(data);
                                    }
                                });


                                $('#expedier_lentilles').on('click', function() {
                                ...
                                $('.content').on('change', '.lensCheck', function() {
                                    ...
                                    $.ajax({
                                        ...
                                        if(res == 'error') {
                                            ...
                                            $('#expedier_lentilles').find('b').text(res);
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#datatable').DataTable({
            ajax: { url: "/admin/valid_commande_lentille_ajax/<?php echo $status ?>", dataSrc: 'aaData' },
            aLengthMenu: [
                [10, 25, 50, 100, 200, -1],
