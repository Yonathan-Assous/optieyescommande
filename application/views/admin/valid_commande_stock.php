            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card-box buttons-box clearfix">
                        ...
                        <a class="btn btn-danger pull-left m-r-10" id="envoi_commande_journaliere" rel="2"><i class="zmdi zmdi-shopping-cart m-r-5"></i> Envoyer liste et etiquettes de stock</a>
                        <a class="btn btn-warning pull-left" id="expedier_commandes"><i class="zmdi zmdi-truck m-r-5"></i> Expedier commandes de stock checkées (<b></b>)</a>
                    </div>
                </div>
                            ...
                            $(document).ready(function() {
                                ...
                                $(".content").on("click",".valid_commande",function() {
                                   ...
                                   // function ajax_call() {
                                        $.ajax({
                                            type: "POST",
                                            url: "/admin/ajouter_etiquetteNEW",
                                            data : "id_commande="+id_commande+"&cote="+verres+"&delete="+supprimer,
                                            error: function(jqXHR, textStatus, errorThrown) {
                                                alert(textStatus+" "+errorThrown);
                                            },
