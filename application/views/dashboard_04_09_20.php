																...
																<div class="panel-body" style="padding-top: 15px">
																	<div class="col-lg-10 card-tabs">
																			<ul class="nav nav-pills type_commande_verre">
																				<li <?php if(is_object($pair_order))  echo 'class="active"';?>><a href="#" data-toggle="tab" aria-expanded="true" id="commande_ferme"><b>Commande ferme</b></a>
																				</li>
																				<?php
																			if($panierA!=1)
																			{?>
																				<li <?php if(is_object($pair_order))  echo 'class="hide"';?>><a href="#" data-toggle="tab" aria-expanded="false" id="casse_atelier"><b>Casse atelier</b></a>
																				</li>
																				<li <?php if(is_object($pair_order))  echo 'class="hide"';?>><a href="#" data-toggle="tab" aria-expanded="false" id="erreur_ophtalmologiste"><b>Erreur ophtalmologiste</b></a>
																				</li>
																			<?php
																			}
																			?>
...
$('input[name=additionG]').change(function() {
    ...
    $( "#to_etape2" ).click(function() {			
		...
		if(type == '1' || (type != '1' &&  tprix <= tcredit))
		{
		...
		else
		{
			swal({
				...
				text: "Votre crédit disponible est insuffisant pour couvrir le montant des verres en commande.",
				type: "warning",
