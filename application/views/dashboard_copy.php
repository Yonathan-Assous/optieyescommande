...
<div role="main" id="main" class="container_12 clearfix">
    ...
    <section id="content" class="container_12 clearfix" data-sort="true">
        ...
        <div class="grid_12 iban_form">
            ...
            <?php if(isset($mandat)) { ?>
                ...
                <div class="box">
                    ...
                    <div class="header">
                        <h2><img src="<?php echo $pre_url;?>static/img/icons/packs/fugue/16x16/ui-tab--arrow.png" class="icon">Mise à jour des informations</h2>
                    </div>
                    ...
                    <div class="content">
                        ...
                        if(isset($mandat)) {
                            if($mandat['state'] == 'active') {
                                ...
                                echo '<span>Votre autorisation de prélèvement a bien été prise en compte, merci.</span>';

                            }
                            else {

                                if($infos_user[0]->document_rib == "" || $infos_user[0]->valid_document_rib != 1) {
                                    $form_lock = true;
                                }

                                echo '<span>Une erreur est survenue lors de l\'autorisation de prélèvement, veuillez réessayer plus tard. Si le problème persiste, n\'hesitez pas à nous contacter !</span>';
                            }
                        }
                        else {
                            if($infos_user[0]->valid_mandat == 1) {
                                echo '<span>Votre autorisation de prélèvement a bien été prise en compte, merci.</span>';
                            }
                        }
                        ?>
            ...
            <?php } else {
                ...
                if(($infos_user[0]->document_rib == "" || $infos_user[0]->valid_document_rib != 1) || $infos_user[0]->valid_mandat == 0 && $slimpay == true) {

                    if($infos_user[0]->document_rib == "") {
                        $form_lock = true;
                        echo '<div class="alert error sticky no-margin-top" style="font-size: 16px;">
                            <strong>Attention !</strong> Vous n\'avez pas encore fourni vos coordonnées bancaires. Vous devez remplir le formulaire suivant afin de pouvoir passer commande.
                          </div>';
                    }
                    elseif($infos_user[0]->valid_document_rib != 1) {
                        $form_lock = true;
                        echo '<div class="alert error sticky no-margin-top" style="font-size: 16px;">
                            <strong>Attention !</strong> Vos informations de paiement semblent incorrectes. Vous devez remplir le formulaire suivant afin de pouvoir passer commande.
                          </div>';
                    }

                    if(time() >= 1465509600) {
                        echo '<div id="form_error_msg" class="alert error sticky no-margin-top" style="font-size: 16px;">
                            <strong>Attention !</strong> Chers clients, afin de simplifier le processus de transactions et de commandes, nous mettons à jour notre système de paiements.
                            Vous avez jusqu\'au 15 Juin pour remplir le formulaire disponible à l\'étape 1, passé ce délais, vous ne pourrez plus passer de commandes tant que vous n\'aurez pas complété vos informations !
                          </div>';
                    }
                    ...
                    <form class="box manual validate" id="update_RIB">
                        ...
                        <span>Chers clients, afin de simplifier le processus de transactions et de commandes, nous mettons à jour notre système de paiements.<br />
                            Vous avez jusqu'au <strong style="color: #ff0000 !important">15 Juin</strong> pour remplir ce formulaire, passé ce délais, vous ne pourrez plus passer de commandes tant que vous n'aurez pas completé vos informations !
                        </span>
                            ...
                            <div id="iban_block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="block">
                                        ...
                                        <div>
                                            <input type="text" class="required" name="companyName" id="companyName" data-error-type="inline" value="<?php echo $user_info->nom_magasin ?>" />
                                        </div>
                                    </div>

                                    <div class="block">
                                        <label for="honorificPrefix" >
                                            <strong>Civilité du gérant</strong>
                                        </label>
                                        <div>

                                            <div style="width:60px;float:left">
                                                <input type="radio" value="1" id="civilite_1" name="honorificPrefix" checked>
                                                <label for="civilite_1">M.</label>
                                            </div>

                                            <div style="width:75px;float:left">
                                                <input type="radio" value="2" id="civilite_2" name="honorificPrefix">
                                                <label for="civilite_2">Mme.</label>
                                            </div>

                                            <div style="width:70px;float:left">
                                                <input type="radio" value="3" id="civilite_3" name="honorificPrefix">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="block">
                                        ...
                                        <div>
                                            <input type="text" class="required" name="familyName" id="familyName" data-error-type="inline" />
                                            <p class="label error inline"></p>
                                        </div>
                                    </div>

                                    <div class="block">
                                        <label for="givenName" >
                                            <strong>Prénom du gérant</strong>
                                        </label>
                                        <div>
                                            <input type="text" class="required" name="givenName" id="givenName" data-error-type="inline" />
                                            <p class="label error inline"></p>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="block address">
                                        <label for="street1">
                                            <strong>Adresse de la société</strong>
                                        </label>
                                        <div>
                                            <input type="text" class="required" name="street1" id="street1" data-error-type="inline" value="<?php echo $user_info->adresse ?>" />
                                            <p class="label error inline"></p>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="block address">
                                        ...
                                        <div>
                                            <input type="text" class="required" name="street2" id="street2" data-error-type="inline" />
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="block">
                                        ...
                                        <div>
                                            <input type="text" class="required" name="city" id="city" data-error-type="inline" value="<?php echo $user_info->ville ?>" />
                                            <p class="label error inline"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="block">
                                        ...
                                        <div>
                                            <input type="text" class="required" name="postalCode" id="postalCode" data-error-type="inline" value="<?php echo $user_info->cp ?>" />
                                            <p class="label error inline"></p>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="block address">
                                        ...
                                        <div>
                                            <input type="text" class="required" name="pays" id="pays" data-error-type="inline" value="France" disabled />
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="block address">
                                        ...
                                        <div>
                                            <input type="text" class="required" name="iban" id="iban" data-error-type="inline" />
                                            <p class="label error inline"></p>
                                        </div>
                                    </div>
                            ...
                            <a class="button" id="sendRIB">Envoyer</a>
        ...
        <div class="grid_12">
            ...
            if($user_info->commande_suspendue == 1){
                $form_lock = true;
                echo '<div class="alert error sticky no-margin-top">
                            <strong>Attention !</strong> La partie commande vous a été restreinte jusqu\'à la régularisation de votre compte. Contactez-nous pour de plus amples informations.
                          </div>';

            }

            /*elseif($user_info->document_rib == ""){
                      echo '<div class="alert error sticky no-margin-top">
                              <strong>Attention !</strong> Vous n\'avez pas encore envoyé votre RIB ! <a href="'.$pre_url.'index/profile">Cliquer ici</a> pour accèder au formulaire d\'envoi et ainsi pouvoir commander.
                            </div>';

                  }elseif($user_info->valid_document_rib == 2){
                          $txt = 'Votre RIB à été refusé, vous devez nous le renvoyer pour pouvoir commander <a href="'.$pre_url.'index/profile">Cliquer ici</a> pour l\'envoyer à nouveau.';

                     echo '<div class="alert error sticky no-margin-top">
                          <strong>Attention !</strong> '.$txt.'
                        </div>';
                  ...
                  }elseif($numero_siret == "nok" || $tva_intracomm == "nok"){
                      if($numero_siret == "nok" && $tva_intracomm == "nok"){
                          $nok = 'numéro siret et votre numéro de Tva Intracommunautaire ne sont pas correct';
                      }
                      elseif($tva_intracomm == "nok"){
                          $nok = 'numéro de Tva Intracommunautaire n\'est pas correct';
                      }

                      $txt = 'Nous avons remarquer que votre '.$nok.'  merci de vous rendre sur votre <a href="'.$pre_url.'index/profile">profile</a> et le complèter avec les informations correctes pour pouvoir commander.';
                ...
                <div class="content">
                    ...
                    <fieldset id="wiz_etape1">
                        ...
                        <div class="row" id="numero_magasin">
                            ...
                            <div>
                                <p> Magasin <?php echo $user_info->id_users; ?></p>
                            </div>
                        </div>
                    </fieldset>
            ...
            <div id="msg_erreur_ec" title="Commande échouée" style="display: none;">
                ...
                <p><a class="button" href="<?php echo base_url() ?>index/erreur_casse">Voir mon historique erreur ophtalmologiste/casse atelier</a></p>
            </div>
        ...
        <script>
            ...
            $$.ready(function(){
                ...
                $('input[name="type_commande_verre"]').on('change', function() {
                    ...
                    if(current_value !== null && current_value != $(this).val()) {
                        window.location.href = 'http://'+window.location.hostname+'/index/passer_commande/?t='+$(this).val();
                    }
            ...
            $("input[id^=type_commande_verre_]").click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "/index/ajax_type_verre/"+type_commande_verre,
                    dataType:"html",
                    success: function(data){
                        if(data == "redirect")
                            window.location.reload();
                            ...
                            if(data!="" && data == "not_logged") {
                                ...
                                if(data.status == 1) {
                                    ...
                                    $.each(data, function(index, value) {
                                        ...
                                        $('#update_RIB input#'+index).siblings('.icon').remove();
                                        if(value == 1) {
                                            $('#update_RIB input#'+index).siblings('p.error').text('Ce champ est requis');
                                        }
                                        else {
                                            $('#update_RIB input#'+index).siblings('p.error').text('Format invalide');
                                        }
                                    });
