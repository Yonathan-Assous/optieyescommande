	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="page-title m-b-10">Mes commandes de montures</h4>
					</div>
				</div>
	...
	<script>
		$(document).ready(function() {
			...
			var table = $('#datatable').DataTable({
				ajax: "/index/mes_commandes_montures_ajax",
				deferRender: true,
				ordering: false,
				columnDefs: [{
					"targets": "_all",
			...
			$(".content").on('change','input[name=option]',function(){
				table.ajax.url('/index/mes_commandes_montures_ajax?tri='+$(this).val()).load();
			});
