...
<?php
    ...
    $count_orders = count($commande);

    $i = 1;

    foreach($commande as $bon_livraison_lentille):

    $user_info = $this->m_users->getUserById($bon_livraison_lentille->id_users)[0];
    $lens = $this->m_lens->getLens($bon_livraison_lentille->lens_id);
    $data_admin['admin_info'] = $this->m_users->getUserById(1)[0];
    $build = json_decode($bon_livraison_lentille->information_commande, true);
...
<div id="body" class="page">
    ...
    <header>
        ...
        <h1 style="text-align: right">BL N° <?php echo $bon_livraison_lentille->intitule_bl; ?></h1>
        <h2 style="text-align: right">Date: <strong><?php echo date("d/m/Y",strtotime($bon_livraison_lentille->date_commande)) ?></strong></h2>
    </header>
        ...
        <div class="page" style="font-size: 7pt">
            ...
            <!--<table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <h1 style="text-align: right">Bon de livraison numéro <?php echo $bon_livraison_lentille->intitule_bl; ?></h1>
                    </td>
                </tr>
            </table>
            <br><br>-->
            ...
            <?php if($bon_livraison_lentille->type_commande == 2)
            ...
            else if($bon_livraison_lentille->type_commande == 3)
            ...
            <table style="width: 100%; font-size: 10pt;z-index:3; text-align: center; margin: 15px 0 5px;">
                ...
                <tr>
                    ...
                    echo'<td>                        
                        <div style="margin-bottom: 4px">Réfence client : <strong>'.$bon_livraison_lentille->reference_client.'</strong></div>
                    ...
                    $data_encode = "";
                    $data_encode = urlencode("Date de commande : ".date("d/m/Y",strtotime($bon_livraison_lentille->date_commande)).", Reference client : ".$bon_livraison_lentille->reference_client.", Numero de BL : ".$bon_livraison_lentille->intitule_bl.', Magasin : '.$user_info->nom_magasin.', Produit : '.$flashcode);
