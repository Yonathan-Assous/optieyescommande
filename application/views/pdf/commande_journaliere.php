                        ...
                        foreach($commande_journaliere as $key => $value){
                            ...
                            if(isset($info_commande['verre']['correction_droit'])){
                                ...
                                if($value->id_type_generation_verre == 4){
                                    ...
                                    $info_commande['verre']['correction_droit']['axe'] = (int) $info_commande['verre']['correction_droit']['axe'];
                                ...
                                $correction_droit = "OD : ".number_format($info_commande['verre']['correction_droit']['sphere'], 2, ',', '')."(".number_format($info_commande['verre']['correction_droit']['cylindre'], 2, ',', '').")".(isset($info_commande['verre']['correction_droit']['axe']) ? $info_commande['verre']['correction_droit']['axe']."°" : "").(isset($info_commande['verre']['correction_droit']['addition']) ? " ADD ".number_format($info_commande['verre']['correction_droit']['addition'], 2, ',', '') : "").(isset($info_commande['verre']['correction_droit']['degression']) ? " DEG ".number_format($info_commande['verre']['correction_droit']['degression'], 2, ',', '') : "");
                            }
                            ...
                            if(isset($info_commande['verre']['correction_gauche'])){
                                ...
                                if($value->id_type_generation_verre == 4){
                                    ...
                                    //$cylindre = ( -1 * abs($info_commande['verre']['correction_gauche']['cylindre']));
                                    //$sphere = ($info_commande['verre']['correction_gauche']['sphere'] + $info_commande['verre']['correction_gauche']['cylindre']);
                                    $info_commande['verre']['correction_gauche']['axe'] = (int) $info_commande['verre']['correction_gauche']['axe'];
                                ...
                                $correction_gauche = "OG : ".number_format($info_commande['verre']['correction_gauche']['sphere'],2,',', '')."(".number_format($info_commande['verre']['correction_gauche']['cylindre'], 2, ',', '').")".(isset($info_commande['verre']['correction_gauche']['axe']) ? $info_commande['verre']['correction_gauche']['axe']."°" : "").(isset($info_commande['verre']['correction_gauche']['addition']) ? " ADD ".number_format($info_commande['verre']['correction_gauche']['addition'], 2, ',', '') : "").(isset($info_commande['verre']['correction_gauche']['degression']) ? " DEG ".number_format($info_commande['verre']['correction_gauche']['degression'], 2, ',', '') : "");
                            }

                            echo'<table style="width: 100%;" class="header">
                                    <tr>
                                        <td><h1 style="text-align: left; display: block; width: 100%;">Magasin '.$value->id_users.' CR'.$value->id_commande.'-'.$value->id_users;

                                        if($value->premiere_commande > 0) { echo '   (2ème paire CR'.$value->premiere_commande.'-'.$value->id_users.')'; }

                                        echo'</h1> '.($value->tarif_express > 0 ? '<span style="font-size: 20px">Express</span>' : '' ).'</td>
                               ...
                               echo '<tr>
                                ...
                                if($correction_droit!=""){
                                    echo'<tr>
											...
											{	
												echo '<td><strong>Diamètre: '.$info_commande['verre']['correction_droit']['diametre'].'</strong></td>';
											}
											else
											{
                                ...
                                if($correction_gauche!=""){
                                    echo'<tr>
											...
											{	
												echo '<td><strong>Diamètre: '.$info_commande['verre']['correction_gauche']['diametre'].'</strong></td>';
											}
											else
											{
               ...
               /* if(isset($info_commande['diametre_verre']))
                  ...
                  */
								...
								if(isset($info_commande['verre']['miroir']))
									$option .= "- ".$options_miroir[$info_commande['verre']['miroir']['type_miroir']];
