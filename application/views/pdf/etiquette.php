                 	...
                 	echo '</tr>
						...
						<table> 
							<tr>
								...
								($value->cote == "droit" ? 'D' : (isset($info_commande['verre']['correction_gauche']['diametre']) ? $info_commande['verre']['correction_gauche']['diametre'] : ""))
								.'</td>
								...
								($value->cote == "gauche" ? 'G' : (isset($info_commande['verre']['correction_droit']['diametre']) ? $info_commande['verre']['correction_droit']['diametre'] : ""))
								.'</td>
							</tr>
						</table>
					</td>
