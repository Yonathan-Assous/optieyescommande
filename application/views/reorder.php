			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card-box">
                        ...
                        if(!empty($recap_commande['trad_fr']))
                        {
        ...
        <tbody>';
                            ...
                            if(isset($info_commande['verre']['correction_droit'])) {
								...
								if(isset($info_commande['verre']['correction_droit']['traitement']) && $info_commande['verre']['correction_droit']['traitement']!=""  && $info_commande['verre']['correction_droit']['traitement']!="0")
								{
									...
									$correction_droit .= $traitement_D."<br>";
								}
                            ...
                            if(isset($info_commande['verre']['correction_gauche'])) {
								...
								if(isset($info_commande['verre']['correction_gauche']['traitement']) && $info_commande['verre']['correction_gauche']['traitement']!=""  && $info_commande['verre']['correction_gauche']['traitement']!="0")
								{
									...
									$correction_gauche .= $traitement_G."<br>";
								}
                            ...
                            if($correction_droit!=''){
								...
								if(isset($info_commande['verre']['correction_droit']['diametre'])) {
									$correction_droit .= 'Diamètre : ' . $info_commande['verre']['correction_droit']['diametre'];
								}
								else
								{
                            ...
                            if($correction_gauche!=''){
								...
								if(isset($info_commande['verre']['correction_gauche']['diametre'])) {
									$correction_gauche .= 'Diamètre : ' . $info_commande['verre']['correction_gauche']['diametre'];
								}
								else
								{
                            ...
                            if($recap_commande['origine_commande'] == 1) {
