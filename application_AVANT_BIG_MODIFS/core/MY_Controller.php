	...
	public function pdf($file_pdf,$data,$data_name_custom_file="",$stream=false, $orientation = 'portrait', $customsize = false){
     ...
     /*   $unwanted_array = array(    'Š'=>'S', 'š'=>'s', 'Ž'=>'Z', 'ž'=>'z', 'À'=>'A', 'Á'=>'A', 'Â'=>'A', 'Ã'=>'A', 'Ä'=>'A', 'Å'=>'A', 'Æ'=>'A', 'Ç'=>'C', 'È'=>'E', 'É'=>'E',
		...
		*/
		...
		$htmla = '<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<body>
...
<div id="body">
    ...
    <header>
        ...
        <h1 style="text-align: right">Facture 2010147</h1>
        <h2 style="text-align: right">31/10/2020</h2>
    </header>
    ...
    <div id="content">
        ...
        //$data = pdf_create(addslashes($html),$file_output,$stream, $orientation, $customsize);
        ...
        if(($this->session->userdata('logged_in') === true || $this->session->userdata('is_admin') === true)){
            ...
            if(!empty($commande)){
                if(($commande[0]->id_users == $data['user_info']->id_users) || $this->session->userdata('is_admin') === true){
					...
					//$html = $this->load->view('pdf/'.$file_pdf, $data,$data_custom_file, true);
