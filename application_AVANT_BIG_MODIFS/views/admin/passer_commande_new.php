...
if($_COOKIE['typecommande'] == "fab_paniera" || $_COOKIE['typecommande'] == "stock_paniera")
{
	$panierA = $user_id;
}
?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 m-b-10">
						...
						//	echo " - ".$panierA_sans_monture;
							if($panierA == $user_id)
								echo " - Panier A";
							echo  ' - '.$_COOKIE['typecommande'];
							?></h4>
                    </div>
                </div>
                        ...
                        if($user_info[0]->commande_suspendue == 1){
                            ...
                            <div class="card-box card-tabs clearfix">
                                ...
                                if(is_object($pair_order)) {
                                    ...
                                    echo  '<a href="http://www.optieyescommande.com/admin/passer_commande/'.$user_info[0]->id_users.'#verre-fabric" data-toggle="tab" aria-expanded="true" rel="1">Verres de fabrication</a>
                                    </li>
                                    <li';
                                    ...
                                    echo  '<a href="http://www.optieyescommande.com/admin/passer_commande/'.$user_info[0]->id_users.'#verre-stock" data-toggle="tab" aria-expanded="false" rel="2">Verres de stock</a>
                                    </li>';
									//if($panierA != $user_id)
									//{
										echo '<li';
									...
									if($_COOKIE['typecommande']=="prog_eco")
										echo '<script>type_commande_verre = 2;</script>';
                                    echo  '<a href="http://www.optieyescommande.com/admin/passer_commande/'.$user_info[0]->id_users.'#verre-stock" data-toggle="tab" aria-expanded="false" rel="2" data-gen="18">Prog eco de stock</a>
											</li>
											<li';
									...
									if($_COOKIE['typecommande']=="fab_paniera")
										echo '<script>type_commande_verre = 1;</script>';
                                    echo  '<a href="http://www.optieyescommande.com/admin/passer_commande/'.$user_info[0]->id_users.'#verre-fabric" data-toggle="tab" aria-expanded="false" rel="1" data-ispaniera="A">Fabrication panier A</a>
											</li>
											<li';
									...
									if($_COOKIE['typecommande']=="stock_paniera")
										echo '<script>type_commande_verre = 2;</script>';
                                    echo  '<a href="http://www.optieyescommande.com/admin/passer_commande/'.$user_info[0]->id_users.'#verre-stock" data-toggle="tab" aria-expanded="false" rel="2" data-ispaniera="A">Stock panier A</a>
											</li>';
									//}
									echo '
                                </ul>';
                                                        ...
                                                        <div class="tab-content m-b-0 b-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix <?php if(false != $pair_order) { echo 'hidden'; } ?>">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
																				<input type="radio" id="type_commande_1" value="1" name="type_commande" class="required" <?php if(false != $pair_order) { echo 'checked'; } ?> <?php if($panierA == $user_id || $panierA_sans_monture == 1)
																					echo "checked"?>>
																				<label for="type_commande_1"> Commande ferme </label>
																			</div>
																			<?php
																			if($panierA != $user_id && $panierA_sans_monture != 1)
																			{ ?>
																			<div class="radio radio-warning radio-inline">
                                                                    ...
                                                                    <div class="form-group clearfix referenceClient">
                                                                ...
                                                                <div id="precalibrage_oui">
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div class="col-lg-10 col-sm-10 col-xs-9">
                                                                            <input id="cotea" name="cotea" type="text" pattern="[0-9]+([\.,][0-9]+)?" class="form-control">
                                                                            <div class="validator"></div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div class="col-lg-10 col-sm-10 col-xs-9">
                                                                            <input id="coteb" name="coteb" type="text" pattern="[0-9]+([\.,][0-9]+)?" class="form-control">
                                                                            <div class="validator"></div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div class="col-lg-10 col-sm-10 col-xs-9">
                                                                            <input id="cotec" name="cotec" type="text" pattern="[0-9]+([\.,][0-9]+)?" class="form-control">
                                                                            <div class="validator"></div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div class="col-lg-10 col-sm-10 col-xs-9">
                                                                            <input id="coted" name="coted" type="text" pattern="[0-9]+([\.,][0-9]+)?" class="form-control">
                                                                            <div class="validator"></div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="step_4">
                                                                ...
                                                                if($commentaire_actif->active == 1)
                                                                    if(isset($user_info[0]->show_commentaire) && $user_info[0]->show_commentaire == 1) {
                                                                        ?>
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="step_5">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div id="type_commande_error" class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning">
																				<input type="radio" id="carte_auth_y" value="1" name="carte_auth" class="required" <?php if($panierA==$user_id || $panierA_sans_monture == 1) echo 'checked';?>>
																				<label for="carte_auth_y"><?php if($panierA==$user_id || $panierA_sans_monture == 1) {?>« La carte d'authenticité est obligatoire pour des produits commandés en panier A »<?php }
																					else
																					{?>Je souhaite un certificat d'authenticité (Gratuit)<?php } ?></label>
																			</div>

																			<div class="radio radio-warning <?php if($panierA==$user_id || $panierA_sans_monture == 1) echo 'hide';?>">
                                                                    ...
                                                                    <div id="civilite_client" class="form-group clearfix auth_fields" <?php if($panierA==$user_id || $panierA_sans_monture == 1) echo 'style="display: block;"';?>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 order-form-container">
                                                ...
                                                <form id="stockForm" method="get" action="" class="form-commande  form-horizontal">
													...
													<?php if($panierA == $user_id || $panierA_sans_monture == 1)
																{ ?>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
																				<input type="radio" id="stock_type_commande_1" value="1" name="type_commande" class="required" <?php if($panierA == $user_id || $panierA_sans_monture == 1)
																					echo "checked"?>>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix" id="show_commande_multiple">
                                                                        ...
                                                                        <div class="col-lg-10" id="multi_commande">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline" <?php if($panierA == $user_id || $panierA_sans_monture == 1)
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="grille clearfix" id="correction_gauche">
                                                                                ...
                                                                                <div class="col-lg-3 col-sm-3 col-xs-6">
                                                                                    ...
                                                                                    <select name="cylindre_gauche" id="cylindre_gauche" class="form-control search required cylindre_select">
            ...
            $('.form-commande').on("change","#sphere_gauche,#cylindre_gauche",function() {
                ...
                if(type_commande_verre == 2)
                    $.ajax({
                        ...
                        data : "cylindre="+$("#cylindre_gauche").val()+"&sphere="+$("#sphere_gauche").val()+"&add="+$("#addition_gauche").val()+"&id_indice_verre="+$('input[name="id_indice_verre"]:checked').val()+"&id_generation_verre="+id_generation_verre_value+"&type_commande_verre="+type_commande_verre+"&teinte="+$('input[name="teinte"]:checked').val()+"&traitement="+$('input[name="traitement"]:checked').val()+"&photocromie="+$('input[name="photocromie"]:checked').val()+"&polarise="+polarise,
                        dataType:"json",
                        success: function(data){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(type_commande_verre == 1){
                            ...
                            if($('input[name="id_generation_verre"]:checked').val() == 24) {
                                $("div").find('[data-side="droit"] > div:eq(3)').html("");
                                 $("div").find('[data-side="gauche"] > div:eq(3)').html("");
                            }
                ...
                if(type_commande_verre == 2){
                    ...
                    if(($(this).attr('name') == 'only_gauche' || $(this).attr('name') == 'only_droit') || ($(this).attr('id') !== undefined && $(this).attr('id').indexOf('diametre') != -1)){
                        ...
                        if($(this).attr('id').indexOf('diametre') == -1 ){
                            ...
                            if((id_generation_verre.val() == 12 || id_generation_verre.val() == 20 || id_generation_verre.val() == 21 || id_generation_verre.val() == 17) && indice_verre.val() == 1){
...
<?php
                ...
                'onNext': function (tab, navigation, index) {
					...
					switch(index) {
						case 2:
							...
							$.ajax({
								type: "POST",
								url: "/admin/setOrderRecap/<?php echo $user_id;?>",
								data : formData,
								dataType:"html",
								beforeSend:function(){
                ...
                'onNext': function (tab, navigation, index) {
                    ...
                    switch(index) {
                        ...
                        case 2:
                            ...
                            $.ajax({
                                type: "POST",
                                url: "/admin/ajax_type_verre/"+type_commande_verre+"<?php if(is_object($pair_order)) { echo '/'.$pair_order->id_type_generation_verre; } ?>",
                                dataType:"html",
            ...
            $('#finish_pair').on('change', function() {
               if($(this).is(':checked')) {
                   $('.finish').find('.btn').text('Valider ma première commande');
               }
               else {
