	...
	<div class="content-page">
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="page-title m-b-10">Mes commandes</h4>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card-box">
							...
							<div class="radio radio-warning radio-inline">
								<input type="radio" id="pending" value="pending" name="option">
	...
	<script>
		$(document).ready(function() {
			...
			$(".content").on('change','input[name=option]',function(){
				table.ajax.url('/index/mes_commandes_ajax?tri='+$(this).val()).load();
			});
