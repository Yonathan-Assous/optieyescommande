            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card-box buttons-box clearfix">
						<a class="btn btn-info pull-left m-r-10" id="envoi_commande_journaliere" rel="4"><i class="zmdi zmdi-truck m-r-5"></i> Generer les étiquettes et checker les commandes</a>
