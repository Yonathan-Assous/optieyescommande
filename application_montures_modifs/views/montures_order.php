            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form id="order">
							<div class="step" id="packs" data-value="">
								<p class="type_commande">Choisissez un pack</p>
								<div class="data packs list"></div>
                       		</div>
							<div class="step" id="collections" data-value="">
								<p class="type_commande">Ou Choisissez une collection</p>
								<div class="data collections list"></div>
                       		</div>
                            <div class="step hidden" id="montures" data-value="">
								<p class="type_commande" id="titreChoisirMontures">Choisissez votre monture</p>
		...
		$('.step').on('click', '.product-select', function() { 
			...
			else if (action.indexOf("add_pack") >= 0)
			{
                ...
                data: { 'id': el.attr('rel') }
					...
					swal({
							title: "Commande de Pack de Montures",
