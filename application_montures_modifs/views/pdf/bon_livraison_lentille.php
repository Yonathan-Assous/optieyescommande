...
<div id="body">
    ...
    <header>
        ...
        <h1 style="text-align: right">BL N° <?php echo $bon_livraison_lentille[0]->intitule_bl; ?></h1>
        <h2 style="text-align: right">Date: <strong><?php echo date("d/m/Y",strtotime($bon_livraison_lentille[0]->date_commande)) ?></strong></h2>
    </header>
        ...
        <div class="page" style="font-size: 7pt">
            ...
            <!--<table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <h1 style="text-align: right">Bon de livraison numéro <?php echo $bon_livraison_lentille[0]->intitule_bl; ?></h1>
                    </td>
                </tr>
            </table>
            <br><br>-->
            ...
            <?php if($bon_livraison_lentille[0]->type_commande == 2)
            ...
            else if($bon_livraison_lentille[0]->type_commande == 3)
            ...
            <table style="width: 100%; font-size: 10pt;z-index:3; text-align: center; margin: 15px 0 5px;">
                ...
                <tr>
                    ...
                    echo'<td>                        
                        ...
                        Référence client : <strong>'.$bon_livraison_lentille[0]->reference_client.'</strong><br />
                    ...
                    $data_encode = urlencode("Date de commande : ".date("d/m/Y",strtotime($bon_livraison_lentille[0]->date_commande)).", Reference client : ".$bon_livraison_lentille[0]->reference_client.", Numero de BL : ".$bon_livraison_lentille[0]->intitule_bl.', Magasin : '.$user_info->nom_magasin.', Produit : '.$flashcode);
