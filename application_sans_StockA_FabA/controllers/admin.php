        ...
        if($this->input->is_ajax_request()){
            ...
            if($commandes) {
                foreach ($commandes as $c) {
                    ...
                    if(($c->id_type_generation_verre == 5 || $c->id_type_generation_verre == 23) && ($c->id_generation_verre == 19 || $c->id_indice_verre == 7 || $c->id_indice_verre == 6 || $correction['verre']['traitement'] == "BlueCoat" || $correction['verre']['traitement'] == "BlueCoat Defender" || isset($correction['verre']['polarise']))) {
                        $type = 'stock';
                    }
                    else {
                        if(($c->id_type_generation_verre == 5 || $c->id_type_generation_verre == 23)) {
                            continue;
                        }
                        $type = 'fabric';
                    }
