                        ...
                        if($user_info[0]->commande_suspendue == 1){
                            ...
                            <div class="card-box card-tabs clearfix">
                                ...
                                if(is_object($pair_order)) {
									...
									{
										echo '<li>
											<a href="#verre-stock" data-toggle="tab" aria-expanded="false" rel="2" data-gen="18">Prog eco de stock</a>
										</li>';
									}
									echo '
                                </ul>';
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="verre-fabric" class="tab-pane fade in <?php echo (null == $pair_order ? 'hidden' : 'active'); ?>">
                                        <div class="row">
                                                        ...
                                                        <div class="tab-content m-b-0 b-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix <?php if(false != $pair_order) { echo 'hidden'; } ?>">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
																				<input type="radio" id="type_commande_1" value="1" name="type_commande" class="required" <?php if(false != $pair_order) { echo 'checked'; } ?> <?php if($panierA == $user_id)
																					echo "checked"?>>
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="step_5">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div id="type_commande_error" class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning">
																				<input type="radio" id="carte_auth_y" value="1" name="carte_auth" class="required" <?php if($panierA==$user_id) echo 'checked';?>>
																				<label for="carte_auth_y"><?php if($panierA==$user_id) {?>« La carte d'authenticité est obligatoire pour des produits commandés en panier A »<?php }
																					else
																					{?>Je souhaite un certificat d'authenticité (Gratuit)<?php } ?></label>
																			</div>

																			<div class="radio radio-warning <?php if($panierA==$user_id) echo 'hide';?>">
                                                                    ...
                                                                    <div id="civilite_client" class="form-group clearfix auth_fields" <?php if($panierA==$user_id) echo 'style="display: block;"';?>>
                                                        ...
                                                        <div class="tab-content m-b-0 b-0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
																				<input type="radio" id="stock_type_commande_1" value="1" name="type_commande" class="required" <?php if($panierA == $user_id)
																					echo "checked"?>>
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="stock_2">
                                                                <div class="row">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
																					<?php if($panierA == $user_id)
																					{?>
                                                                                    <div class="radio radio-warning"><input type="radio" id="gamme_verres_23"  value="23" name="id_generation_verre" class="required" 
																					 >
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix indice_vere">
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix" id="show_commande_multiple">
                                                                        ...
                                                                        <div class="col-lg-10" id="multi_commande">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline" <?php if($panierA == $user_id)
