                ...
                if(is_array($commande_journaliere)){
                    ...
                    foreach($commande_journaliere as $key => $value){
                       ...
                       $info_commande = json_decode($value->information_commande, true);
						...
						if ($value->generation_verre == "Stock teinté" )
						{
                       ...
                       if(strpos($value->libelle_verre, '{color}') !== false) {
                           if (isset($info_commande['verre']['miroir_stock']['type_miroir'])) {
                               $name = str_replace('{color}',$options_miroir[$info_commande['verre']['miroir_stock']['type_miroir']], $value->libelle_verre);
                               $name_gauche = str_replace('{color}',$options_miroir[$info_commande['verre']['miroir_stock']['type_miroir']], $value->libelle_verre);
                           }
                       }
