            ...
            echo ' <td class="fc-widget-content'.($jourEnCours == $jour ? ' fc-state-highlight' : '').'" style="width:133px;">
                        <div style="min-height: 73px;">
                            ...
                            <div class="fc-day-content">
                                <div style="position: relative; text-align:center;">HT : '.number_format($total_ht ,2,'.',' ').' € </div>
                                <div style="position: relative; text-align:center;">P&E : '.number_format($this->m_commande->getPackagingByDay($currentdate) ,2,'.',' ').' €</div>
                                <div style="position: relative; text-align:center;">Lentilles : '.(0 !== $lens_day->total_commande ? number_format($lens_day->total_commande ,2,'.',' ') : number_format(0 ,2,'.',' ')).' €</div>
                                <div style="position: relative; text-align:center;">Sup : '.$this->m_commande->getSupplementByDay($currentdate).'€</div>
                            </div>
                        </div>
                    </td>';
