                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix <?php if(false != $pair_order) { echo 'hidden'; } ?>">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="type_commande_1" value="1" name="type_commande" class="required" <?php if(false != $pair_order) { echo 'selected'; } ?>>
                                            ...
                                            <div class="col-md-12 order-form-container">
                                                ...
                                                <form id="stockForm" method="get" action="" class="form-commande  form-horizontal">
                                                    ...
                                                    <div id="stockwizard" class="pull-in">
                                                        <ul>
                                                            <li><a href="#stock_1" data-toggle="tab"><span>Etape 1 <b>/ 3</b></span><i>Commande</i></a></li>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="stock_type_commande_1" value="1" name="type_commande" class="required">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    <div class="radio radio-warning">
                                                                                        <input type="radio" id="gamme_verres_9" value="9" name="id_generation_verre" class="required">
                        ...
                        if(type_commande_verre == 1){
                            ...
                            /*if($('input[name="id_generation_verre"]:checked').val() == 16 && id_indice_verre == 1) {
                                ...
                                if(generation_verre == 12 || generation_verre == 14 || generation_verre == 17 || generation_verre == 20) {
                                    ...
                                    <?php if($user_info[0]->id_users == 222 || $user_info[0]->id_users == 233): ?>
                                    if(id_indice_verre == 4) {
