    ...
    <div id="content">
        ...
        <div class="page" style="font-size: 7pt">
                    ...
                    echo ' <td class="fc-widget-content'.($jourEnCours == $nbJour ? ' fc-state-highlight' : '').'" style="border-bottom:1px solid;width:80px;">
                                <div style="min-height: 73px;">
                                    ...
                                    <div class="fc-day-content">
                                        ...
                                        <div style="text-align:center;margin-top:10px;">TTC : '.number_format($total_ttc ,2,'.',' ').' €</div>
            ...
            <table style="width: 100%; border: 1px solid black; font-size: 8pt;border-collapse: collapse;">
                ...
                <tr>
                    <td style="border: 1px solid black;text-align:center;">Avec frais de livraison inclus</td>
                    <?php
                ...
                <tr>
                    <td style="border: 1px solid black;text-align:center;">Hors frais de livraison</td>
                    <?php
                ...
                <tr>
                    ...
                    $lens_month = $this->m_lens->getLensIncomesByMonth($currenttime->format('Y-m'));
