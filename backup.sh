...
rm -r /var/www/vhosts/optieyescommande.com/httpdocs_new/backup.sql.bz2
bzip2 /var/www/vhosts/optieyescommande.com/httpdocs_new/backup.sql
/root/.google-drive-upload/bin/gupload /var/www/vhosts/optieyescommande.com/httpdocs_new/backup.sql.bz2
