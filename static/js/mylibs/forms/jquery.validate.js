...
$.extend($.validator, {
	...
	messages: {
		...
		number: "Entrez un n.",
		digits: "Entrer seulement des chiffres.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Entrer la même valeur pour confirmer.",
		accept: "Entrer un fichier avec une extension valide.",
		maxlength: $.validator.format("N'entrez pas plus de {0} caractères."),
		minlength: $.validator.format("Entrez minimum {0} caractères."),
