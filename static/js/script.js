...
(function($, mango, undefined){
	...
	mango.register('forms', ['mylibs/forms/jquery.checkbox', 'mylibs/forms/jquery.chosen', 'mylibs/forms/jquery.fileinput', 'mylibs/forms/jquery.ellipsis', 'mylibs/forms/jquery.autosize', 'mylibs/forms/jquery.pwdmeter', 'mylibs/forms/jquery.maskedinput', 'mylibs/forms/uploader/plupload', 'mylibs/forms/uploader/plupload.html5', 'mylibs/forms/uploader/plupload.html4', 'mylibs/forms/uploader/plupload.flash', 'mylibs/forms/uploader/jquery.plupload.queue/jquery.plupload.queue', 'mylibs/forms/jquery.colorpicker', 'mylibs/forms/jquery.cleditor'], {
		...
		init: function() {
			...
			var formResize = function(){
				$('#content,#inscription,#login,#inscription,.ui-dialog:not(:has(#settings))').find('form').each(function(){
					var $form = $(this);
	...
	mango.ready(function(){
        ...
        $inscription.height($msg.height());
        //$inscription.children().css('position', 'absolute');

		// Set up validation
		var $form = $login.find('form'), $form_inscription = $inscription.find('form');
        ...
        $form.validationOptions({
            ...
            submitHandler: function(){
                $.ajax({
                    type: "POST",
                    url: base_url+"index/check_login",
                    data: $form.serialize(),
                    dataType: 'json',
        ...
        var success_message = $("#msg_success_subscribe"), account_exist = $("#msg_account_exist");
        var incorrect_siret = $("#msg_incorrect_siret"), incorrect_tva_intra_comm = $("#msg_incorrect_tva_intra_comm"), siret_exist = $("#siret_exist");

        $form_inscription.validationOptions({
            invalidHandler: function(){
                $form_inscription.find('.welcome').fadeOut();
                $form_inscription.find('.failure').fadeIn();
            },
            submitHandler: function(){
                $.ajax({
                    type: "POST",
                    url: base_url+"index/subscribe",
                    data: $form_inscription.serialize(),
                    dataType: 'json',
                    success: function(msg){
						if(msg.status == "DUPLICATE"){
							siret_exist.dialog( "open" );
						}
                        else if(msg.status == "exists"){
                            account_exist.dialog( "open" );
                        }
                        else if(msg.status == "error_siret"){
                            incorrect_siret.dialog( "open" );
                        }
                        else if(msg.status == "error_tva_intra_comm"){
                            incorrect_tva_intra_comm.dialog( "open" );
                        }
	...
	mango.ready(function(){
		...
		mango.utils.preload([
			base_url+'static/img/layout/navigation/arrow-active.png',
			base_url+'static/img/layout/navigation/arrow-hover.png',
			base_url+'static/img/layout/navigation/arrow.png',
			base_url+'static/img/layout/navigation/bg-current.png',
			base_url+'static/img/layout/navigation/bg-active.png',
			base_url+'static/img/layout/navigation/bg-hover.png',
			base_url+'static/img/layout/navigation/bg-normal.png'
		]);

		mango.utils.preload([
			base_url+'static/img/layout/sidebar/bg-right.png',
			base_url+'static/img/layout/sidebar/bg.png',
			base_url+'static/img/layout/sidebar/divider.png',
			base_url+'static/img/layout/sidebar/shadow-right.png',
			base_url+'static/img/layout/sidebar/shadow.png',
			base_url+'static/img/layout/sidebar-right/header-bg.png',
			base_url+'static/img/layout/sidebar-right/nav-bg-hover.png',
			base_url+'static/img/layout/sidebar-right/nav-bg.png'
		]);

		mango.utils.preload([
			base_url+'static/img/layout/toolbar/bg.png',
			base_url+'static/img/layout/toolbar/buttons/bg-active.png',
			base_url+'static/img/layout/toolbar/buttons/bg-disabled.png',
			base_url+'static/img/layout/toolbar/buttons/bg-hover.png',
			base_url+'static/img/layout/toolbar/buttons/bg-red-active.png',
			base_url+'static/img/layout/toolbar/buttons/bg-red-disabled.png',
			base_url+'static/img/layout/toolbar/buttons/bg-red-hover.png',
			base_url+'static/img/layout/toolbar/buttons/bg-red.png',
			base_url+'static/img/layout/toolbar/buttons/bg.png',
			base_url+'static/img/layout/toolbar/buttons/divider.png'
		]);

		mango.utils.preload([base_url+'static/img/layout/footer/divider.png']);


		mango.utils.preload([
			base_url+'static/img/layout/bg.png',
			base_url+'static/img/layout/content/box/actions-bg.png',
			base_url+'static/img/layout/content/box/bg.png',
			base_url+'static/img/layout/content/box/header-bg.png',
			base_url+'static/img/layout/content/box/menu-active-bg.png',
			base_url+'static/img/layout/content/box/menu-arrow.png',
			base_url+'static/img/layout/content/box/menu-bg.png',
			base_url+'static/img/layout/content/box/menu-item-bg-hover.png',
			base_url+'static/img/layout/content/box/menu-item-bg.png',
			base_url+'static/img/layout/content/box/tab-hover.png',
			base_url+'static/img/layout/content/toolbar/bg-shortcuts.png',
			base_url+'static/img/layout/content/toolbar/bg.png',
			base_url+'static/img/layout/content/toolbar/divider.png',
			base_url+'static/img/layout/content/toolbar/popup-arrow.png',
			base_url+'static/img/layout/content/toolbar/popup-header.png',
			base_url+'static/img/layout/content/toolbar/user/arrow-normal.png',
			base_url+'static/img/layout/content/toolbar/user/avatar-bg.png',
			base_url+'static/img/layout/content/toolbar/user/avatar.png',
			base_url+'static/img/layout/content/toolbar/user/bg-hover.png',
			base_url+'static/img/layout/content/toolbar/user/bg-menu-hover.png',
			base_url+'static/img/layout/content/toolbar/user/counter.png'
		]);


		mango.utils.preload([
			base_url+'static/img/elements/alert-boxes/bg-error.png',
			base_url+'static/img/elements/alert-boxes/bg-information.png',
			base_url+'static/img/elements/alert-boxes/bg-note.png',
			base_url+'static/img/elements/alert-boxes/bg-success.png',
			base_url+'static/img/elements/alert-boxes/bg-warning.png',
			base_url+'static/img/elements/alert-boxes/error.png',
			base_url+'static/img/elements/alert-boxes/information.png',
			base_url+'static/img/elements/alert-boxes/note.png',
			base_url+'static/img/elements/alert-boxes/success.png',
			base_url+'static/img/elements/alert-boxes/warning.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/breadcrumb/bg-active.png',
			base_url+'static/img/elements/breadcrumb/bg-hover.png',
			base_url+'static/img/elements/breadcrumb/divider-active.png',
			base_url+'static/img/elements/breadcrumb/divider-hover.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/headerbuttons/bg-active.png',
			base_url+'static/img/elements/headerbuttons/bg-hover.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/autocomplete/el-bg-hover.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/calendar/arrow-hover-bg.png'
		]);

		mango.utils.preload([base_url+'static/img/elements/charts/hover-bg.png']);

		mango.utils.preload([
			base_url+'static/img/elements/messages/button-active-bg.png',
			base_url+'static/img/elements/messages/button-hover-bg.png'
		]);
		...
		mango.utils.preload([
			base_url+'static/img/elements/mail/actions-bg.png',
			base_url+'static/img/elements/mail/button-bg-disabled.png',
			base_url+'static/img/elements/mail/button-bg-hover.png',
			base_url+'static/img/elements/mail/button-bg.png',
			base_url+'static/img/elements/mail/button-red-bg-hover.png',
			base_url+'static/img/elements/mail/button-red-bg.png',
			base_url+'static/img/elements/mail/button-red-disabled.png',
			base_url+'static/img/elements/mail/hover-bg.png',
			base_url+'static/img/elements/mail/mail.png',
			base_url+'static/img/elements/mail/text-arrow.png',
			base_url+'static/img/elements/mail/text-bg.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/fullstats/list/hover-bg.png',
			base_url+'static/img/elements/fullstats/simple/a-active.png',
			base_url+'static/img/elements/fullstats/simple/a-hover.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/checkbox/checked-active.png',
			base_url+'static/img/elements/checkbox/checked-disabled.png',
			base_url+'static/img/elements/checkbox/checked-hover.png',
			base_url+'static/img/elements/checkbox/checked-normal.png',
			base_url+'static/img/elements/checkbox/unchecked-active.png',
			base_url+'static/img/elements/checkbox/unchecked-disabled.png',
			base_url+'static/img/elements/checkbox/unchecked-hover.png',
			base_url+'static/img/elements/checkbox/unchecked-normal.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/radiobutton/checked-active.png',
			base_url+'static/img/elements/radiobutton/checked-disabled.png',
			base_url+'static/img/elements/radiobutton/checked-hover.png',
			base_url+'static/img/elements/radiobutton/checked-normal.png',
			base_url+'static/img/elements/radiobutton/unchecked-active.png',
			base_url+'static/img/elements/radiobutton/unchecked-disabled.png',
			base_url+'static/img/elements/radiobutton/unchecked-hover.png',
			base_url+'static/img/elements/radiobutton/unchecked-normal.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/colorpicker/arrow.png',
			base_url+'static/img/elements/colorpicker/bg.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/forms/icon-error.png',
			base_url+'static/img/elements/forms/icon-success.png',
			base_url+'static/img/elements/forms/tooltip-error-arrow.png',
			base_url+'static/img/elements/forms/tooltip-error.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/profile/change-active-bg.png',
			base_url+'static/img/elements/profile/change-hover-bg.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/search/arrow.png',
			base_url+'static/img/elements/search/glass.png',
			base_url+'static/img/elements/search/list-hover.png',
			base_url+'static/img/elements/search/loading.gif'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/select/bg-active.png',
			base_url+'static/img/elements/select/bg-hover.png',
			base_url+'static/img/elements/select/bg-right-hover.png',
			base_url+'static/img/elements/select/list-hover-bg.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/settings/header-bg.png',
			base_url+'static/img/elements/settings/header-current-bg.png',
			base_url+'static/img/elements/settings/header-hover-bg.png',
			base_url+'static/img/elements/settings/seperator-current-left.png',
			base_url+'static/img/elements/settings/seperator-current-right.png',
			base_url+'static/img/elements/settings/seperator.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/slide-unlock/lock-slider.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/spinner/arrow-down-active.png',
			base_url+'static/img/elements/spinner/arrow-down-hover.png',
			base_url+'static/img/elements/spinner/arrow-up-active.png',
			base_url+'static/img/elements/spinner/arrow-up-hover.png',
			base_url+'static/img/elements/table/pagination/active.png',
			base_url+'static/img/elements/table/pagination/disabled.png',
			base_url+'static/img/elements/table/pagination/hover.png',
			base_url+'static/img/elements/table/toolbar/hover.png',
			base_url+'static/img/elements/table/sorting-asc.png',
			base_url+'static/img/elements/table/sorting-desc.png',
			base_url+'static/img/elements/table/sorting.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/tags/bg.png',
			base_url+'static/img/elements/tags/left.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/to-top/active.png',
			base_url+'static/img/elements/to-top/hover.png',
			base_url+'static/img/elements/to-top/normal.png'
		]);

		mango.utils.preload([base_url+'static/img/elements/tooltips/bg.png']);

		mango.utils.preload([
			base_url+'static/img/elements/upload/bg-hover.png',
			base_url+'static/img/elements/upload/bg-normal.png'
		]);

		mango.utils.preload([
			base_url+'static/img/elements/wizard/arrow-current.png',
			base_url+'static/img/elements/wizard/arrow-error.png',
			base_url+'static/img/elements/wizard/arrow-normal.png',
			base_url+'static/img/elements/wizard/arrow-success.png',
			base_url+'static/img/elements/wizard/bg-current.png',
			base_url+'static/img/elements/wizard/bg-error.png',
			base_url+'static/img/elements/wizard/bg-normal.png',
			base_url+'static/img/elements/wizard/bg-success.png',
			base_url+'static/img/elements/wizard/bg.png'
		]);

		mango.utils.preload([
			base_url+'static/img/external/chosen-sprite.png'
		]);

		mango.utils.preload([
			base_url+'static/img/external/colorpicker/blank.gif',
			base_url+'static/img/external/colorpicker/colorpicker_background.png',
			base_url+'static/img/external/colorpicker/colorpicker_hex.png',
			base_url+'static/img/external/colorpicker/colorpicker_hsb_b.png',
			base_url+'static/img/external/colorpicker/colorpicker_hsb_h.png',
			base_url+'static/img/external/colorpicker/colorpicker_hsb_s.png',
			base_url+'static/img/external/colorpicker/colorpicker_indic.gif',
			base_url+'static/img/external/colorpicker/colorpicker_overlay.png',
			base_url+'static/img/external/colorpicker/colorpicker_rgb_b.png',
			base_url+'static/img/external/colorpicker/colorpicker_rgb_g.png',
			base_url+'static/img/external/colorpicker/colorpicker_rgb_r.png',
			base_url+'static/img/external/colorpicker/colorpicker_select.gif',
			base_url+'static/img/external/colorpicker/colorpicker_submit.png',
			base_url+'static/img/external/colorpicker/custom_background.png',
			base_url+'static/img/external/colorpicker/custom_hex.png',
			base_url+'static/img/external/colorpicker/custom_hsb_b.png',
			base_url+'static/img/external/colorpicker/custom_hsb_h.png',
			base_url+'static/img/external/colorpicker/custom_hsb_s.png',
			base_url+'static/img/external/colorpicker/custom_indic.gif',
			base_url+'static/img/external/colorpicker/custom_rgb_b.png',
			base_url+'static/img/external/colorpicker/custom_rgb_g.png',
			base_url+'static/img/external/colorpicker/custom_rgb_r.png',
			base_url+'static/img/external/colorpicker/custom_submit.png',
			base_url+'static/img/external/colorpicker/select.png',
			base_url+'static/img/external/colorpicker/select2.png',
			base_url+'static/img/external/colorpicker/slider.png'
		]);

		mango.utils.preload([
			base_url+'static/img/external/editor/buttons.gif',
			base_url+'static/img/external/editor/toolbar.gif'
		]);

		mango.utils.preload([
			base_url+'static/img/external/explorer/arrows-active.png',
			base_url+'static/img/external/explorer/arrows-normal.png',
			base_url+'static/img/external/explorer/crop.gif',
			base_url+'static/img/external/explorer/dialogs.png',
			base_url+'static/img/external/explorer/icons-big.png',
			base_url+'static/img/external/explorer/icons-small.png',
			base_url+'static/img/external/explorer/logo.png',
			base_url+'static/img/external/explorer/progress.gif',
			base_url+'static/img/external/explorer/quicklook-bg.png',
			base_url+'static/img/external/explorer/quicklook-icons.png',
			base_url+'static/img/external/explorer/resize.png',
			base_url+'static/img/external/explorer/spinner-mini.gif',
			base_url+'static/img/external/explorer/toolbar.png'
		]);

		mango.utils.preload([
			base_url+'static/img/external/gallery/blank.gif',
			base_url+'static/img/external/gallery/fancybox_buttons.png',
			base_url+'static/img/external/gallery/fancybox_loading.gif',
			base_url+'static/img/external/gallery/fancybox_sprite.png'
		]);

		mango.utils.preload([
			base_url+'static/img/external/jquery-ui/ui-bg_flat_0_000000_40x100.png',
			base_url+'static/img/external/jquery-ui/ui-bg_flat_30_000000_40x100.png',
			base_url+'static/img/external/jquery-ui/ui-bg_flat_65_e3e3e3_40x100.png',
			base_url+'static/img/external/jquery-ui/ui-bg_flat_75_ffffff_40x100.png',
			base_url+'static/img/external/jquery-ui/ui-bg_glass_55_fbf9ee_1x400.png',
			base_url+'static/img/external/jquery-ui/ui-bg_highlight-hard_100_f0f0f0_1x100.png',
			base_url+'static/img/external/jquery-ui/ui-bg_highlight-soft_100_e8e8e8_1x100.png',
			base_url+'static/img/external/jquery-ui/ui-bg_highlight-soft_75_b3bfcb_1x100.png',
			base_url+'static/img/external/jquery-ui/ui-bg_inset-soft_95_fef1ec_1x100.png',
			base_url+'static/img/external/jquery-ui/ui-icons_222222_256x240.png',
			base_url+'static/img/external/jquery-ui/ui-icons_2e83ff_256x240.png',
			base_url+'static/img/external/jquery-ui/ui-icons_3a4450_256x240.png',
			base_url+'static/img/external/jquery-ui/ui-icons_454545_256x240.png',
			base_url+'static/img/external/jquery-ui/ui-icons_888888_256x240.png',
			base_url+'static/img/external/jquery-ui/ui-icons_cd0a0a_256x240.png'
		]);

		mango.utils.preload([
			base_url+'static/img/external/uploader/backgrounds.gif',
			base_url+'static/img/external/uploader/buttons-disabled.png',
			base_url+'static/img/external/uploader/buttons.png',
			base_url+'static/img/external/uploader/delete.gif',
			base_url+'static/img/external/uploader/done.gif',
			base_url+'static/img/external/uploader/error.gif',
			base_url+'static/img/external/uploader/throbber.gif',
			base_url+'static/img/external/uploader/transp50.png'
		]);

		mango.utils.preload([
			base_url+'static/img/jquery-ui/accordion-header-active.png',
			base_url+'static/img/jquery-ui/accordion-header-hover.png',
			base_url+'static/img/jquery-ui/accordion-header.png',
			base_url+'static/img/jquery-ui/datepicker/arrow-left.png',
			base_url+'static/img/jquery-ui/datepicker/arrow-right.png',
			base_url+'static/img/jquery-ui/datepicker/button-bg.png',
			base_url+'static/img/jquery-ui/datepicker/button-hover-bg.png',
			base_url+'static/img/jquery-ui/datepicker/button-seperator.png',
			base_url+'static/img/jquery-ui/datepicker/day-current.png',
			base_url+'static/img/jquery-ui/datepicker/day-hover.png',
			base_url+'static/img/jquery-ui/datepicker/days-of-week-bg.png',
			base_url+'static/img/jquery-ui/datepicker/header-bg.png',
			base_url+'static/img/jquery-ui/datepicker/time-bg.png',
			base_url+'static/img/jquery-ui/datepicker/top-arrow.png',
			base_url+'static/img/jquery-ui/dialog-titlebar-close-hover.png',
			base_url+'static/img/jquery-ui/dialog-titlebar.png',
			base_url+'static/img/jquery-ui/loading.gif',
			base_url+'static/img/jquery-ui/progressbar/bg.png',
			base_url+'static/img/jquery-ui/progressbar/fill-blue-small.png',
			base_url+'static/img/jquery-ui/progressbar/fill-blue.gif',
			base_url+'static/img/jquery-ui/progressbar/fill-blue.png',
			base_url+'static/img/jquery-ui/progressbar/fill-grey.gif',
			base_url+'static/img/jquery-ui/progressbar/fill-grey.png',
			base_url+'static/img/jquery-ui/progressbar/fill-orange-small.png',
			base_url+'static/img/jquery-ui/progressbar/fill-orange.gif',
			base_url+'static/img/jquery-ui/progressbar/fill-orange.png',
			base_url+'static/img/jquery-ui/progressbar/fill-red-small.png',
			base_url+'static/img/jquery-ui/progressbar/fill-red.gif',
			base_url+'static/img/jquery-ui/progressbar/fill-red.png',
			base_url+'static/img/jquery-ui/slider/bg-range.png',
			base_url+'static/img/jquery-ui/slider/bg.png',
			base_url+'static/img/jquery-ui/slider/disabled-bg-range.png',
			base_url+'static/img/jquery-ui/slider/disabled-bg.png',
			base_url+'static/img/jquery-ui/slider/disabled-picker.png',
			base_url+'static/img/jquery-ui/slider/disabled-vertical-bg-range.png',
			base_url+'static/img/jquery-ui/slider/disabled-vertical-bg.png',
			base_url+'static/img/jquery-ui/slider/disabled-vertical-picker.png',
			base_url+'static/img/jquery-ui/slider/picker.png',
			base_url+'static/img/jquery-ui/slider/vertical-bg-range.png',
			base_url+'static/img/jquery-ui/slider/vertical-bg.png',
			base_url+'static/img/jquery-ui/slider/vertical-picker.png'
		]);
