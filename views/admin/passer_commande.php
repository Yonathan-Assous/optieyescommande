                                                        ...
                                                        <div class="tab-content m-b-0 b-0">
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="stock_1">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            <input id="stock_reference_client" name="reference_client" type="text" class="required form-control">
                                                                            <div class="validator"></div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="stock_2">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix indice_vere">
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix traitement">
                                                                    ...
                                                                    <div class="form-group rd-180 clearfix photochromie" id="show_photocromie">
                                                                    ...
                                                                    <div class="form-group rd-180 clearfix" id="show_miroir_stock">
                                                                        ...
                                                                        <div class="col-lg-10" id="miroir_stock">
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="miroir_bleu" value="1" name="miroir_stock" class="required">
                                                                                <label for="miroir_bleu"> Bleu </label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="miroir_dore" value="3" name="miroir_stock" class="required">
                                                                                <label for="miroir_dore"> Doré </label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="miroir_vert" value="4" name="miroir_stock" class="required">
                                                                                <label for="miroir_vert"> Vert </label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="miroir_rouge" value="5" name="miroir_stock" class="required">
                                                                                <label for="miroir_rouge"> Rouge </label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="miroir_argent" value="2" name="miroir_stock" class="required">
                                                                                <label for="miroir_argent"> Argent </label>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-group rd-180 clearfix" id="show_polarisation">
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix" id="show_commande_multiple">
                                                                        ...
                                                                        <div class="col-lg-10" id="multi_commande">
                                                                            ...
                                                                            <div id="multi_commande_oui_message">
                                                                                <select name="nb_multi_commande" id="nb_multi_commande" class="form-control">
                                                                                    <option value="">Nombre de commandes identiques</option>
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix corrections" id="show_correction_droit">
                                                                        <label class="col-lg-2 control-label">Correction oeil droit</label>
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="grille clearfix" id="correction_droit">
                                                                                ...
                                                                                <div class="col-lg-3 col-sm-3 col-xs-6">
                                                                                    ...
                                                                                    <select name="cylindre_droit" id="cylindre_droit" class="form-control search required">
                                                                                        <option value=""></option>
                                                                                        <?php
                                                                                        for($i = 0; $i <= 10; $i+=0.25){
                                                                                            echo '<option value="'.$i.'" '.($i == 0 ? 'selected="selected"' : '').'>'.($i == 0 ? '0.00' : ($i > 0 ? '+'.$i : $i)).'</option>';
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix" id="show_diametre">
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix corrections" id="show_correction_gauche">
                                                                        <label class="col-lg-2 control-label">Correction oeil gauche</label>
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="grille clearfix" id="correction_gauche">
                                                                                ...
                                                                                <div class="col-lg-3 col-sm-3 col-xs-6">
                                                                                    ...
                                                                                    <select name="cylindre_gauche" id="cylindre_gauche" class="form-control search required">
                                                                    ...
                                                                    <div class="form-group rd-100 clearfix" id="show_diametre_gauche">
                                                                        <label class="col-lg-2 control-label">Diamètre verre gauche</label>
                                                                        <div class="col-lg-10" id="diametre_gauche">

                                                                            <div class="radio radio-warning radio-inline groupe1">
                                                                                <input type="radio" value="55" id="diametre_gauche_55" name="diametre_gauche">
                                                                                <label for="diametre_gauche_55">55</label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline groupe1 groupe2">
                                                                                <input type="radio" value="60" id="diametre_gauche_60" name="diametre_gauche">
                                                                                <label for="diametre_gauche_60">60</label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline groupe1 groupe2 groupe3 groupe4 groupe6">
                                                                                <input type="radio" value="65" id="diametre_gauche_65" name="diametre_gauche">
                                                                                <label for="diametre_gauche_65">65</label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline groupe1 groupe3 groupe4 groupe5">
                                                                                <input type="radio" value="70" id="diametre_gauche_70" name="diametre_gauche">
                                                                                <label for="diametre_gauche_70">65/70</label>
                                                                            </div>

                                                                            <div class="radio radio-warning radio-inline groupe4 groupe6">
                                                                                <input type="radio" value="75" id="diametre_gauche_75" name="diametre_gauche">
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="last_step_stock">
