...
?>
                                                    ...
                                                    <div id="fabricwizard" class="pull-in">
                                                        ...
                                                        <div class="tab-content m-b-0 b-0">
                                                            ...
                                                            <div class="tab-pane m-t-10 fade" id="step_4">
                                                                ...
                                                                <div class="form-group corrections correction_droit clearfix" id="droit">
                                                                ...
                                                                <div class="form-group corrections correction_gauche clearfix" id="gauche">
                                                                ...
                                                                <div class="form-group miroirs clearfix">
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        ...
                                                                        <div class="options_content panel-collapse collapse m-t-20" aria-expanded="false" id="orderPrism">
                                                                            ...
                                                                            <label class="control-label miroir"><b>6 € par verre</b><br />Miroir en HMC face interne inclus dans ce tarif</label>
                                                                            ...
                                                                            <div class="radio radio-warning radio-inline">
                                                                                <input type="radio" id="miroir_rouge" value="5" name="miroir" class="required">
                                                                    ...
                                                                    <div class="form-group rd-200 clearfix">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="radio radio-warning">
                                                                                ...
                                                                                <label for="gamme_verres_14"> Stock Miroité </label>
                                                                            </div>

                                                                            <div class="radio radio-warning">
                                                                                <input type="radio" id="gamme_verres_17" value="17" name="id_generation_verre" class="required">
                                                                                <label for="gamme_verres_17"> Stock Polarisé </label>
                                                                            </div>
    ...
    <!-- Form wizard -->
    <script src="/static/assetsplugins/bootstrap-wizard/jquery.bootstrap.wizard.js"></script>
    <script src="/static/assetsplugins/jquery-validation/dist/jquery.validate.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    beforeSend: function(){
                        if(type_commande_verre == 1){
                            ...
                            if($('input[name="id_type_generation_verre"]:checked').val() != 2 && $('input[name="id_type_generation_verre"]:checked').val() != 3) {
                                $('.options').show();
                            }
                    ...
                    success: function(data){
                        ...
                        if(type_commande_verre == 1){
                            ...
                            if($('input[name="id_generation_verre"]:checked').val() == 16 && id_indice_verre == 1) {
                                ...
                                if(generation_verre == 12 || generation_verre == 14 || generation_verre == 17) {

                                    if(generation_verre == 12 || generation_verre == 14) {
                                    ...
                                    if(id_generation_verre.val() == 12 || id_generation_verre.val() == 13 || id_generation_verre.val() == 14){
                ...
                if(type_commande_verre == 2){
                    ...
                    if(($(this).attr('name') == 'only_gauche' || $(this).attr('name') == 'only_droit') || ($(this).attr('id') !== undefined && $(this).attr('id').indexOf('diametre') != -1)){
                        ...
                        if($(this).attr('id').indexOf('diametre') == -1 ){
                            ...
                            if((id_generation_verre.val() == 12 || id_generation_verre.val() == 17) && indice_verre.val() == 1){
                            ...
                            if((id_generation_verre.val() == 16 && indice_verre.val() == 1) || id_generation_verre.val() == 15 && ((indice_verre.val() == 1 && (traitement.val() == "HMC" || traitement.val() == "BlueCoat")) || (indice_verre.val() == 4 && traitement.val() == "HMC"))){
                        ...
                        case 4:
                            ...
                            if(type_generation_verre > 0 && type_generation_verre < 4) {
                                ...
                                if(forceAddStep == false && (
                                    ((sph_droit == cyl_droit == axe_droit == 0) && add_droit == '0.75')
                                    || ((sph_gauche == cyl_gauche == axe_gauche == 0) && add_gauche == '0.75'))
                                ) {
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    if(data !== undefined ) {
                                        var nverre = data.replace('Durci', '');
                                        $('span.nom_verre').text(nverre);
                                    }
                                },
                            });
            ...
            $('.finish').on('click', function() {
                ...
                if(type_commande_verre == 2 && ($('input[name="id_indice_verre"]:checked').val() == 6 || $('input[name="id_indice_verre"]:checked').val() == 7 || BlueCoat != -1 || (Polarise != -1 && $('input[name="id_generation_verre"]:checked').val() != 17))){
