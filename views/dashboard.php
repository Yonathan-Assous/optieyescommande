...
?>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12 m-b-10">
						<h4 class="page-title">Passer une commande</h4>
					</div>
				</div>
																...
																<div class="row">
																	...
																	<div class="form-group rd-200 clearfix <?php if(false != $pair_order) { echo 'hidden'; } ?>">
																		...
																		<div class="col-lg-10">
																			...
																			<div class="radio radio-warning radio-inline">
																				<input type="radio" id="type_commande_1" value="1" name="type_commande" class="required" <?php if(false != $pair_order) { echo 'checked'; } ?>>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    <div class="radio radio-warning">
                                                                                        ...
                                                                                        <label for="gamme_verres_20"> <span <?php if(time() < strtotime('30 September 2018')) : ?>class="blink"<?php endif; ?>>Stock bi-couleur plan</span> </label>
                                                                                    </div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('.stock_bi_color label')
                .on('mouseenter', function() {
                    $(this).append('<img src="http://devproxi.optieyescommande.com/static/img/verres/'+$(this).data('img')+'" />');
                })
                        ...
                        if(type_commande_verre == 1){
							...
							/*if($('input[name="id_generation_verre"]:checked').val() == 16 && id_indice_verre == 1) {
								...
								if(generation_verre == 12 || generation_verre == 14 || generation_verre == 17 || generation_verre == 20 ) {
									...
									if(id_generation_verre.val() == 12 || id_generation_verre.val() == 20 || id_generation_verre.val() == 13 || id_generation_verre.val() == 14){
				...
				if(type_commande_verre == 2){
					...
					if(($(this).attr('name') == 'only_gauche' || $(this).attr('name') == 'only_droit') || ($(this).attr('id') !== undefined && $(this).attr('id').indexOf('diametre') != -1)){
						...
						if($(this).attr('id').indexOf('diametre') == -1 ){
							...
							if((id_generation_verre.val() == 12 || id_generation_verre.val() == 20 || id_generation_verre.val() == 17) && indice_verre.val() == 1){

								if($('input[name="traitement"]').is(':checked')) {

                                    if(id_generation_verre.val() == 20) {
                                        $("#show_teinte").find('.stock_reg').hide();
                                        $("#show_teinte").find('.stock_bi_color').show();
                                    }
                                    else {
                                        $("#show_teinte").find('.stock_reg').show();
                                        $("#show_teinte").find('.stock_bi_color').hide();
                                    }
