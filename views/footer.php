...
<script src="<?php echo $pre_url;?>static/assetsplugins/bootstrap-sweetalert/sweet-alert.min.js"></script>
...
if(isset($modules)) {
    ...
    if(array_key_exists('datepicker', $modules)) {
        echo '<script src="'. $pre_url .'static/assetsplugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>';
        echo '<script src="'. $pre_url .'static/assetsplugins/bootstrap-datepicker/dist/locales/bootstrap-datepicker.fr.min.js"></script>';
    }

    if(array_key_exists('touchspin', $modules)) {
        echo '<script src="'. $pre_url .'static/assetsplugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"></script>';
    }
