...
<head>
    ...
    <link href="<?php echo $pre_url;?>static/assetsplugins/bootstrap-sweetalert/sweet-alert.css" rel="stylesheet" type="text/css" />
    ...
    <?php
        if(isset($modules)) {
            ...
            if(array_key_exists('datatables', $modules)) {
                ...
                echo '<link href="/static/assetsplugins/datatables/buttons.bootstrap.min.css" rel="stylesheet" type="text/css" />';
                echo '<link href="/static/assetsplugins/datatables/fixedHeader.bootstrap.min.css" rel="stylesheet" type="text/css" />';
                echo '<link href="/static/assetsplugins/datatables/responsive.bootstrap.min.css" rel="stylesheet" type="text/css" />';
                echo '<link href="/static/assetsplugins/datatables/scroller.bootstrap.min.css" rel="stylesheet" type="text/css" />';
            }
