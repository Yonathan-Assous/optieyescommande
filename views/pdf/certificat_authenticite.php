            ...
            <div class="preview_auth_card" <?php if ($i > 0) echo 'style="top: 6px;"' ?>>
                ...
                <div class="corrections" <?php echo 'style="'.$cstyles.'"' ?>>
                    ...
                    <div class="verres" <?php echo 'style="'.$ostyles.'"' ?>>
                        ...
                        <div class="options">
                            <span class="miroir"><?php if (isset($info_commande['verre']['miroir']['type_miroir'])) echo $options_miroir[$info_commande['verre']['miroir']['type_miroir']] . ' HMC face interne'; ?></span><span class="galbe"><?php if (isset($info_commande['verre']['galbe'])) echo $sep . 'Galbe ' . $info_commande['verre']['galbe']; ?></span>
                        </div>
                    </div>
